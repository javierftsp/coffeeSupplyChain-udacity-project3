...
contract SupplyChain is Ownable, FarmerRole, DistributorRole, RetailerRole, ConsumerRole {
  ...
  // Define a modifer that verifies the Caller is owner of item
  modifier verifyCallerIsOwner (uint _upc) {
  ...
  // Call modifier to verify is a distributor
  onlyDistributor
  // Call modifier to check if upc has passed previous supply chain stage
  forSale(_upc)
  ...
  // Call modifier to verify is a retailer
  onlyRetailer()
  // Call modifier to check if upc has passed previous supply chain stage
  shipped(_upc)
  ...
  // Call modifier to verify is a consumer
  onlyConsumer
  // Call modifier to check if upc has passed previous supply chain stage
  received(_upc)
  // Access Control List enforced by calling Smart Contract / DApp
